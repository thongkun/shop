 	...
 	<div class="container-fluid bg">
 		<div class="row">
			...
			<div class="col-5">
				...
				<h6 class="chutrang2"><i class="fas fa-phone-alt"></i> &#160;&#160;Chăm sóc khách hàng : 0905.027.527</h6>
				<h1 style="color: #333;">
			...
			<div class="col-2">
				...
				<label class="fb"><a href="https://www.facebook.com/onisince2019/" target="_blank">
										<i class="fab fa-facebook-square"></i></a>&#160;&#160;
								  <a href="https://www.instagram.com/onisince2019/"  target="_blank">
			...
			<div class="col-12">
				<br>
				<h3 class="chutrang text-center">Copyrights © 2021 by ThongKunn Official. Powered by Oni-Shoes</h3>
			</div>
 		</div>
